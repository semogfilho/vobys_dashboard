        ...
        if not st.session_state.df_bancario.empty:
            ...
            if 'processamento_pendente' in st.session_state and st.session_state.processamento_pendente:
                ...
                for idx, registro in enumerate(registros):
                    ...
                    # Alerta caso o banco não retorne dados
                ...
                # Remove a pendência após percorrer os registros
                del st.session_state.processamento_pendente

                if st.button("Voltar ao Painel", key="btn_voltar_painel_pos_processamento"):
                    st.rerun()

            else:
                # Exibição principal da tabela (Sem st.form)
                    ...
                    if not cpf_limpo:
                        ...
                        with st.spinner('Consultando CPF...'):
                            if st.session_state.df_bancario[mask_cpf].any().any():
                                ...
                                st.data_editor(
                                    st.session_state.df_bancario[mask_cpf],
                                    hide_index=True,
                                    use_container_width=True,
                        ...
                        if st.button("⬅️ Voltar para lista completa", key="btn_voltar_lista_busca_cpf"):
                            st.rerun()
