...
def inicializar_estado():
    defaults = {
        ...
        "login_atual": None,
        "perfil_usuario": None,
        "sub_menu_auditoria": "Consistência Folha" # ADICIONE ESTA LINHA
    }
...
def get_opcoes():
    opcoes_base = ["Inicio", "Grafico", "Pagto Pendente", "Responsavel", "Arquivos/ID", "Auditoria", "Auditoria Folha"]
    # Removido o item "Validação BB" do perfil 'a'
    if st.session_state.get("perfil_usuario") in ['a', 'g', 'c']:
        return opcoes_base + ["Usuários"]
    return opcoes_base
        ...
        with st.container(border=True):
            ...
            st.radio(
	         ...
	         "Dados Bancários", 
                ...
                key="sub_menu_auditoria" # O Streamlit vai atualizar st.session_state automaticamente
            )
